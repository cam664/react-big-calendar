...
function (_React$Component) {
  ...
  _proto.render = function render() {
    var _this$props = this.props,
        ...
        labelMonth = _this$props.label.split(' ')[0],
        labelYear = _this$props.label.split(' ')[1];
    ...
    }, labelMonth, _react.default.createElement("span", {
      className: "rbc-toolbar-label-year"
    }, labelYear)), _react.default.createElement("button", {
      type: "button",
